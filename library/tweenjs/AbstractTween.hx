...
extern class AbstractTween extends EventDispatcher
{
	 ...
	 */
	function setPosition(rawPosition:Float, ?ignoreActions:Bool, ?jump:Bool, ?callback:Function) : Void;
	 ...
	 */
	function getLabels() : Array<{ label:String, position:Float }>;
	 ...
	 */
	function gotoAndPlay(positionOrLabel:EitherType<Float, String>) : Void;

	/**
	 * Pauses this timeline and jumps to the specified position or label.
	 */
	function gotoAndStop(positionOrLabel:EitherType<Float, String>) : Void;
    
	/**
	 * If a numeric position is passed, it is returned unchanged. If a string is passed, the position of the
	 * corresponding frame label will be returned, or `null` if a matching label is not defined.
	 */
	function resolve(positionOrLabel:EitherType<Float, String>) : Float;
